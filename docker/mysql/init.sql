...
CREATE TABLE reviews (
    ...
    cleaning_company_id BIGINT NOT NULL,
    ...
    FOREIGN KEY (cleaning_company_id) REFERENCES cleaning_companies(id),
    INDEX idx_user_id (user_id),
    INDEX idx_cleaning_company_id (cleaning_company_id),
...
('admin', 'admin@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDa', '管理员', 'ADMIN'),
('user1', 'user1@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDa', '用户1', 'USER'),
('user2', 'user2@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDa', '用户2', 'USER');
...
INSERT INTO reviews (user_id, cleaning_company_id, rating, title, content, service_type, service_date, price) VALUES
